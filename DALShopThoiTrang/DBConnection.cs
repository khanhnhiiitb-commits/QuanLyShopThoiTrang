...
namespace DALShopThoiTrang
{
    public class DBConnection
    {
        ...
        private string connectionString = @"Data Source=DESKTOP-HD4B2VM;Initial Catalog=QuanLyShopThoiTrang;Integrated Security=True;Encrypt=False;TrustServerCertificate=True;"; //KhanhNhi
