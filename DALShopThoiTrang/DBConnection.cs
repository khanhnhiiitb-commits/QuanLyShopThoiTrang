...
namespace DALShopThoiTrang
{
    public class DBConnection
    {
        ...
        private string connectionString = @"Data Source = LAPTOP - 5T9MBNT0\SQLEXPRESS;Initial Catalog = QuanLyShopThoiTrang; Integrated Security = True; TrustServerCertificate=True"; //HongNha
