...
namespace DALShopThoiTrang
{
    public class DBConnection
    {
        ...
        private string connectionString = @"Data Source=.\SQLEXPRESS;Initial Catalog=QuanLyShopThoiTrang2; Integrated Security=True; TrustServerCertificate=True"; //HongNha
