...
namespace DALShopThoiTrang
{
    public class DBConnection
    {
       ...
       // private string connectionString = @"Data Source=LAPTOP-SAHSTOKR\SQLEXPRESS;Initial Catalog=QuanLyShopThoiTrang;Integrated Security=True"; //Duyên
        private string connectionString = @"Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=QuanLyShopThoiTrang;Integrated Security=True;Encrypt=False;TrustServerCertificate=True";// ThuLieu
